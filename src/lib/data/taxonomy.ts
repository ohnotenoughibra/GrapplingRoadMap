...
export const TECHNIQUES: TechniqueSeed[] = [
  ...
  // Takedowns
  { name: "Double Leg", slug: "double-leg", description: "Level change, penetration step, drive through both legs", positionSlug: "standing", discipline: "all", category: "takedown", difficulty: "fundamental" },
  { name: "Single Leg (High Crotch)", slug: "single-leg-high-c", description: "Attack one leg at hip level, turn the corner to finish", positionSlug: "standing", discipline: "all", category: "takedown", difficulty: "fundamental" },
  { name: "Single Leg (Low)", slug: "single-leg-low", description: "Shoot to the ankle/knee level single", positionSlug: "standing", discipline: "all", category: "takedown", difficulty: "intermediate" },
  { name: "Ankle Pick", slug: "ankle-pick", description: "Snap down and grab the far ankle while controlling the head", positionSlug: "standing", discipline: "all", category: "takedown", difficulty: "fundamental" },
  { name: "Snap Down", slug: "snap-down", description: "Pull opponent's head down using collar tie to force turtle or front headlock", positionSlug: "standing", discipline: "all", category: "takedown", difficulty: "fundamental" },
  { name: "Arm Drag to Back", slug: "arm-drag-back", description: "2-on-1 pull to clear the arm and take the back", positionSlug: "standing", discipline: "all", category: "takedown", difficulty: "fundamental" },
  { name: "Duck Under", slug: "duck-under", description: "From underhook, duck under opponent's arm to reach the back", positionSlug: "standing", discipline: "all", category: "takedown", difficulty: "intermediate" },
  { name: "Fireman's Carry", slug: "firemans-carry", description: "Drop under opponent's arm and carry them over your shoulder", positionSlug: "standing", discipline: "wrestling", category: "takedown", difficulty: "intermediate" },
  { name: "Bodylock Takedown", slug: "bodylock-takedown", description: "Clasp hands around opponent's waist and trip or lift", positionSlug: "standing", discipline: "all", category: "takedown", difficulty: "intermediate" },
  { name: "Guard Pull", slug: "guard-pull", description: "Controlled pull to closed or open guard", positionSlug: "standing", discipline: "all", category: "transition", difficulty: "fundamental" },

  // Throws
  { name: "Osoto Gari", slug: "osoto-gari", description: "Major outer reap — classic judo throw", positionSlug: "standing", discipline: "gi", category: "throw", difficulty: "intermediate" },
  { name: "Ouchi Gari", slug: "ouchi-gari", description: "Major inner reap targeting opponent's far leg", positionSlug: "standing", discipline: "gi", category: "throw", difficulty: "intermediate" },
  { name: "Seoi Nage", slug: "seoi-nage", description: "Shoulder throw, turning in under opponent", positionSlug: "standing", discipline: "gi", category: "throw", difficulty: "intermediate" },
  { name: "Harai Goshi", slug: "harai-goshi", description: "Sweeping hip throw", positionSlug: "standing", discipline: "gi", category: "throw", difficulty: "advanced" },
  { name: "Uchi Mata", slug: "uchi-mata", description: "Inner thigh throw — one of the most effective throws in judo", positionSlug: "standing", discipline: "gi", category: "throw", difficulty: "advanced" },
  { name: "Lateral Drop", slug: "lateral-drop", description: "Over-under or bodylock to lateral throw", positionSlug: "standing", discipline: "all", category: "throw", difficulty: "advanced" },

  // Standing defense
  { name: "Sprawl", slug: "sprawl", description: "Hips back, chest down to defend shot", positionSlug: "standing", discipline: "all", category: "defense", difficulty: "fundamental" },
  ...
  { name: "Hip Bump Sweep", slug: "hip-bump-sweep", description: "Post on one hand, bump hips to off-balance and come on top", positionSlug: "closed-guard", discipline: "all", category: "sweep", difficulty: "fundamental" },
  { name: "Scissor Sweep", slug: "scissor-sweep", description: "Shin across belly, pull sleeve, chop legs to sweep", positionSlug: "closed-guard", discipline: "all", category: "sweep", difficulty: "fundamental" },
  { name: "Flower Sweep (Pendulum)", slug: "flower-sweep", description: "Control sleeve and pants, pendulum legs to sweep", positionSlug: "closed-guard", discipline: "gi", category: "sweep", difficulty: "fundamental" },
  ...
  { name: "Spider Sweep", slug: "spider-sweep", description: "Off-balance and sweep from spider guard grips", positionSlug: "open-guard", discipline: "gi", category: "sweep", difficulty: "intermediate" },
  { name: "Lasso Sweep", slug: "lasso-sweep", description: "Use the lasso wrap to sweep opponent overhead or to the side", positionSlug: "open-guard", discipline: "gi", category: "sweep", difficulty: "intermediate" },
  ...
  { name: "Collar Drag", slug: "collar-drag", description: "From seated guard, drag opponent's collar to take back", positionSlug: "open-guard", discipline: "gi", category: "sweep", difficulty: "fundamental" },
  ...
  { name: "Underhook Sweep", slug: "underhook-sweep-hg", description: "Get the underhook, come to knees, drive through to top", positionSlug: "half-guard", discipline: "all", category: "sweep", difficulty: "fundamental" },
  { name: "Old School Sweep", slug: "old-school-sweep", description: "Deep half entry, come under opponent and sweep to top", positionSlug: "half-guard", discipline: "all", category: "sweep", difficulty: "intermediate" },
  ...
  { name: "Electric Chair", slug: "electric-chair", description: "From lockdown, whip up and stretch opponent's legs", positionSlug: "half-guard", discipline: "all", category: "sweep", difficulty: "intermediate" },
  ...
  { name: "Half Guard Recovery", slug: "hg-to-full-guard", description: "Reguard from half guard back to full or open guard", positionSlug: "half-guard", discipline: "all", category: "escape", difficulty: "fundamental" },

  // ═══════════════════════════════════════════════════════════════════
  // BUTTERFLY GUARD
  // ═══════════════════════════════════════════════════════════════════
  { name: "Butterfly Sweep (Hook Sweep)", slug: "butterfly-sweep", description: "Underhook, elevate with hook, sweep to mount", positionSlug: "butterfly-guard", discipline: "all", category: "sweep", difficulty: "fundamental" },
  { name: "Arm Drag from Butterfly", slug: "arm-drag-butterfly", description: "Pull arm across to take the back from butterfly", positionSlug: "butterfly-guard", discipline: "all", category: "transition", difficulty: "fundamental" },
  ...
  { name: "Butterfly to X-Guard", slug: "butterfly-to-x", description: "Transition from butterfly hooks to X-guard entry", positionSlug: "butterfly-guard", discipline: "all", category: "transition", difficulty: "intermediate" },
  ...
  { name: "DLR Sweep (Basic)", slug: "dlr-sweep-basic", description: "Off-balance with DLR hook, kick leg through to sweep", positionSlug: "de-la-riva", discipline: "all", category: "sweep", difficulty: "intermediate" },
  { name: "Berimbolo", slug: "berimbolo", description: "Invert from DLR to take the back", positionSlug: "de-la-riva", discipline: "all", category: "transition", difficulty: "advanced" },
  { name: "DLR to X-Guard", slug: "dlr-to-x", description: "Transition from DLR hook underneath to X-guard", positionSlug: "de-la-riva", discipline: "all", category: "transition", difficulty: "intermediate" },
  { name: "RDLR Sweep", slug: "rdlr-sweep", description: "Reverse De La Riva hook to off-balance and come on top", positionSlug: "de-la-riva", discipline: "all", category: "sweep", difficulty: "intermediate" },

  // ═══════════════════════════════════════════════════════════════════
  // X-GUARD / SLX
  // ═══════════════════════════════════════════════════════════════════
  { name: "X-Guard Sweep (Stand Up)", slug: "x-guard-standup", description: "Elevate and stand to dump opponent, come to top", positionSlug: "x-guard", discipline: "all", category: "sweep", difficulty: "intermediate" },
  { name: "Technical Stand Up from SLX", slug: "slx-standup", description: "Control leg from single leg X, stand to single leg", positionSlug: "x-guard", discipline: "all", category: "sweep", difficulty: "intermediate" },
  ...
  { name: "50/50 Sweep", slug: "fifty-fifty-sweep", description: "Coming on top from 50/50 entanglement", positionSlug: "fifty-fifty", discipline: "all", category: "sweep", difficulty: "intermediate" },
  ...
  { name: "Gift Wrap to Back", slug: "gift-wrap-back", description: "Control wrist across face, use it to take the back", positionSlug: "mount", discipline: "all", category: "transition", difficulty: "intermediate" },

  // Mount escapes
  { name: "Trap & Roll (Upa)", slug: "trap-roll", description: "Bridge and roll trapping arm and leg on same side", positionSlug: "mount", discipline: "all", category: "escape", difficulty: "fundamental" },
  { name: "Elbow-Knee Escape (Shrimp)", slug: "elbow-knee-escape", description: "Frame on hip, shrimp to recover half guard or guard", positionSlug: "mount", discipline: "all", category: "escape", difficulty: "fundamental" },
  ...
  { name: "Mount Transition", slug: "side-to-mount", description: "Transition from side control to full mount", positionSlug: "side-control", discipline: "all", category: "transition", difficulty: "fundamental" },
  { name: "KOB Transition", slug: "side-to-kob", description: "Transition from side control to knee on belly", positionSlug: "side-control", discipline: "all", category: "transition", difficulty: "fundamental" },

  // Side control escapes
  { name: "Shrimp to Guard", slug: "shrimp-escape-sc", description: "Frame, shrimp hips, recover guard with knee-elbow connection", positionSlug: "side-control", discipline: "all", category: "escape", difficulty: "fundamental" },
  { name: "Underhook Escape", slug: "underhook-escape-sc", description: "Get underhook, turn into opponent, recover to knees or single leg", positionSlug: "side-control", discipline: "all", category: "escape", difficulty: "fundamental" },
  { name: "Ghost Escape", slug: "ghost-escape", description: "Turn away, create space, slip out from under opponent", positionSlug: "side-control", discipline: "all", category: "escape", difficulty: "intermediate" },
  ...
  // Back escapes
  { name: "Back Escape (Shoulder Walk)", slug: "back-escape-shoulder", description: "Get shoulders to mat, strip hooks, escape to guard", positionSlug: "back-control", discipline: "all", category: "escape", difficulty: "fundamental" },
  { name: "Back Escape (Hand Fighting)", slug: "back-escape-hands", description: "Two-on-one grip fighting to strip the choking arm", positionSlug: "back-control", discipline: "all", category: "escape", difficulty: "fundamental" },
  ...
  { name: "Sit-Out from Turtle", slug: "sit-out", description: "Post hand, kick leg through, turn to face opponent", positionSlug: "turtle", discipline: "all", category: "escape", difficulty: "fundamental" },
  { name: "Granby Roll", slug: "granby-roll", description: "Invert and roll to recover guard from turtle", positionSlug: "turtle", discipline: "all", category: "escape", difficulty: "intermediate" },
  { name: "Peterson Roll", slug: "peterson-roll", description: "Wrestling-based roll to escape from bottom turtle", positionSlug: "turtle", discipline: "wrestling", category: "escape", difficulty: "intermediate" },
  ...
  { name: "Seatbelt to Back Take", slug: "seatbelt-back-take", description: "Get seatbelt grip, insert hooks to take the back", positionSlug: "turtle", discipline: "all", category: "transition", difficulty: "fundamental" },
  ...
  { name: "Go-Behind from Front Headlock", slug: "go-behind-fhl", description: "Spin behind to take the back from front headlock", positionSlug: "front-headlock", discipline: "all", category: "transition", difficulty: "fundamental" },
  ...
  { name: "Kneebar", slug: "kneebar", description: "Extend opponent's knee hyperextending the joint", positionSlug: "leg-entanglements", discipline: "nogi", category: "submission", difficulty: "advanced" },
  ...
  { name: "Toe Hold", slug: "toe-hold", description: "Figure-four grip on foot, rotating ankle/foot", positionSlug: "leg-entanglements", discipline: "all", category: "submission", difficulty: "advanced" },
  { name: "Calf Slicer", slug: "calf-slicer", description: "Compression lock on the calf from leg entanglement or back", positionSlug: "leg-entanglements", discipline: "nogi", category: "submission", difficulty: "advanced" },
  ...
  // GUARD TOP (Passing)
  // ═══════════════════════════════════════════════════════════════════
  { name: "Toreando Pass", slug: "toreando", description: "Control legs, push to one side, step around to side control", positionSlug: "guard-top", discipline: "all", category: "pass", difficulty: "fundamental" },
  { name: "Knee Cut Pass", slug: "knee-cut", description: "Slice knee through guard to cross to side control", positionSlug: "guard-top", discipline: "all", category: "pass", difficulty: "fundamental" },
  { name: "Over-Under Pass", slug: "over-under", description: "One arm over, one arm under legs, pressure pass to side", positionSlug: "guard-top", discipline: "all", category: "pass", difficulty: "intermediate" },
  { name: "Leg Drag", slug: "leg-drag", description: "Push legs across body line, pin hip and pass", positionSlug: "guard-top", discipline: "all", category: "pass", difficulty: "intermediate" },
  { name: "Stack Pass", slug: "stack-pass", description: "Drive forward folding opponent, walk around their guard", positionSlug: "guard-top", discipline: "all", category: "pass", difficulty: "fundamental" },
  { name: "Long Step Pass", slug: "long-step", description: "From headquarters, long step around guard to complete pass", positionSlug: "guard-top", discipline: "all", category: "pass", difficulty: "intermediate" },
  { name: "Smash Pass", slug: "smash-pass", description: "Heavy crossface pressure, smashing half guard flat", positionSlug: "guard-top", discipline: "all", category: "pass", difficulty: "intermediate" },
  { name: "Body Lock Pass", slug: "bodylock-pass", description: "Clasp hands around waist, use pressure to pass guard", positionSlug: "guard-top", discipline: "nogi", category: "pass", difficulty: "intermediate" },
  ...
  { name: "Stand Up (Wrestling)", slug: "standup-wrestling", description: "Base, hand control, stand and face opponent from bottom", positionSlug: "wrestling-mat", discipline: "wrestling", category: "escape", difficulty: "fundamental" },
  { name: "Switch", slug: "switch", description: "Reverse position by switching hips underneath", positionSlug: "wrestling-mat", discipline: "wrestling", category: "escape", difficulty: "intermediate" },
  { name: "Sit-Out Turn-In", slug: "sit-out-turn-in", description: "Sit out, turn in to face opponent from bottom", positionSlug: "wrestling-mat", discipline: "wrestling", category: "escape", difficulty: "fundamental" },
...
export const MILESTONES: MilestoneSeed[] = [
  {
    ...
    techniqueSlugs: [
      // Standing
      "double-leg", "guard-pull", "sprawl", "collar-tie",
      // Closed Guard
      "armbar-closed-guard", "triangle-closed-guard", "kimura-closed-guard", "hip-bump-sweep", "scissor-sweep",
      // Passing
      ...
      // Turtle
      "turtle-defense", "sit-out", "seatbelt-back-take",
      // Front Headlock
      "front-headlock-control", "guillotine-arm-in",
      // Half Guard
      "knee-shield", "underhook-sweep-hg", "hg-to-full-guard",
      // Butterfly
      "butterfly-sweep",
      // Leg Locks
      "straight-ankle",
  ...
  },
  {
    ...
    techniqueSlugs: [
      // Standing
      "single-leg-high-c", "ankle-pick", "snap-down", "arm-drag-back", "whizzer", "russian-tie", "underhook",
      // Closed Guard
      "guillotine-closed-guard", "cross-collar-guard", "flower-sweep", "ato-chain", "omoplata-guard",
      // Open Guard
      "collar-sleeve-guard", "sit-up-guard", "collar-drag", "spider-guard", "lasso-guard",
      // Half Guard
      "old-school-sweep", "lockdown", "kimura-half-guard",
      // Butterfly
      "arm-drag-butterfly", "guillotine-butterfly",
      // Mount
      "cross-choke-mount", "ezekiel-mount", "gift-wrap-back",
      // Side Control
      "far-armbar-side", "side-to-kob", "ghost-escape",
      // Back
      "bow-arrow", "short-choke", "body-triangle",
      // Turtle
      "granby-roll", "clock-choke",
      // Front Headlock
      "darce", "go-behind-fhl",
      // Passing
      "over-under", "leg-drag", "smash-pass",
      // Leg Lock
      "leg-lock-defense", "ashi-garami",
      // KOB
      "kob-pressure",
      // Wrestling
  ...
  },
  {
    ...
    techniqueSlugs: [
      ...
      // Open Guard
      "spider-sweep", "lasso-sweep", "triangle-lasso",
      // Half Guard
      ...
      // 50/50
      "fifty-fifty-control", "fifty-fifty-sweep",
      // Mount
      "mounted-triangle",
      // Side Control
      ...
      // Leg Locks
      "kneebar", "inside-heel-hook", "toe-hold",
      // Passing
  ...
  },
  {
    ...
    techniqueSlugs: [
      ...
      "berimbolo",
      // Advanced Leg Locks
      "outside-heel-hook", "heel-hook-slx", "heel-hook-fifty", "kneebar-fifty", "calf-slicer",
      // Advanced Positions
      "crucifix-control", "crucifix-choke",
      // Advanced Escapes
      "peterson-roll",
      // Advanced Wrestling
      "turk-ride",
