...
interface TechniqueProgress {
  ...
  level: SkillLevel | null; // null = not yet tracked
}
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-mat-100">My Journey</h1>
          <p className="text-mat-400 text-sm mt-1">
            Your personal skill map. Every node is a step on your path.
          </p>
        </div>
                                        ...
                                        t.level === "proficient"
                                          ...
                                          : t.level === "sparring"
                                            ...
                                            : t.level === "drilling"
                                              ...
                                              : t.level === "exposed"
                                                ? "skill-exposed"
                                                : "bg-mat-800/20 border-mat-800/30"
                                      }`}
                                    >
                                      ...
                                      <span
                                        className={`text-[10px] font-medium ${levelConfig?.color ?? "text-mat-600"}`}
                                      >
                                        {levelConfig?.label ?? "—"}
                                      </span>
                                    </div>
