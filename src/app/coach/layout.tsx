...
/* 5 primary nav items: Home, Log, Calendar, Students, More (overflow) */
const COACH_NAV = [
  {
    label: "Home",
  ...
  /* ── Overflow items (shown in "More" sheet on mobile, sidebar on desktop) ── */
  {
    label: "Heatmap",
    href: "/coach/heatmap",
    icon: (
...
export default function CoachLayout({
  ...
  return (
    <AppShell role="coach" items={COACH_NAV}>
      {children}
    </AppShell>
  );
}
